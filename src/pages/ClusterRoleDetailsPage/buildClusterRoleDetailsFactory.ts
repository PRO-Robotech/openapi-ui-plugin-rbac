...
import type { TClusterRoleDetailsPageComponentMap } from './ClusterRoleDetailsPage'

const API_GROUP = 'rbac.authorization.k8s.io'
const API_VERSION = 'v1'
const PLURAL = 'clusterroles'
...
const buildClusterRoleDetailsPath = (basePath: string) => `${basePath}/clusterroles/{chosenEntryValue}`

export const buildClusterRoleDetailsFactory = ({
  clusterId,
  clusterRoleName,
  basePath,
}: {
  ...
  basePath: string
}): TFactoryDataK8s<TClusterRoleDetailsPageComponentMap> => {
  const runtimeFactoryConfig = getRuntimeFactoryConfig()
  const endpoint = `/api/clusters/${clusterId}/k8s/apis/${API_GROUP}/${API_VERSION}/${PLURAL}/${clusterRoleName}`
            ...
            children: [
              ...
              },
              {
                ...
                data: {
                  ...
                  redirectUrl: buildClusterRoleDetailsPath(basePath),
                },
              },
              {
                type: 'CopyButton',
              ...
              actions: [
                ...
                },
                {
                  ...
                  props: {
                    ...
                    redirectTo: `${OPENAPI_UI_BASEPREFIX}/${clusterId}/api-table/${API_GROUP}/${API_VERSION}/${PLURAL}`,
                    text: 'Delete',
                  },
                },
              ],
              ...
              children: [
                {
                  ...
                  children: [
                    ...
                    //         {
                    //           type: 'ContentCard',
                    //           data: { id: 'clusterrole-runtime-facts-card' },
                    //           children: [
                    //             {
                    //               type: 'DefaultDiv',
                    //               data: {
  ...
  } as unknown as TFactoryDataK8s<TClusterRoleDetailsPageComponentMap>
}
